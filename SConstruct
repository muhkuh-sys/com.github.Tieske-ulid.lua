...
#
shutil.unpack_archive('ulid.lua-0.1.0.tar.gz', 'targets/depack')
strDepackPath = 'targets/depack/ulid.lua-0.1.0/'
...
tArcList.AddFiles('lua',
                  os.path.join(strDepackPath, 'src', 'ulid.lua'))
